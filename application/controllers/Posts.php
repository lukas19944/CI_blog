...
class Posts extends CI_Controller{
    ...
    public function create(){
        ...
        $data['title'] = 'Stwórz post';
        
        $data['categories']= $this->post_model->get_categories();
        
        $this->form_validation->set_rules('title', 'Title', 'required');
        $this->form_validation->set_rules('body', 'Zawartość', 'required');
    ...
    public function delete($id){
        ...
        //set message
             $this->session->set_flashdata('post_deleted', 'Post został usunięty');
    ...
    public function update() {
        ...
        //set message
             $this->session->set_flashdata('post_updated', 'Post został zaaktualizowny');
